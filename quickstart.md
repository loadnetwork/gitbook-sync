...
{% hint style="info" %}
To easily feed Load Network docs to your favourite LLM, access the compressed knowledge (aka LLM.txt) file from Load Network: [llmtxt.xyz/g/loadnetwork/gitbook-sync/22](https://llmtxt.xyz/g/loadnetwork/gitbook-sync/22) (last update: 15/12/2025, 10:00:00 UTC)
{% endhint %}
