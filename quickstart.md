...
{% hint style="info" %}
To easily feed Load Network docs to your favourite LLM, access the compressed knowledge (aka LLM.txt) file from Load Network: [llmtxt.xyz/g/loadnetwork/gitbook-sync/15](https://www.llmtxt.xyz/g/loadnetwork/gitbook-sync/15) (last update: 29/10/2025, 16:30:07 UTC)
{% endhint %}
