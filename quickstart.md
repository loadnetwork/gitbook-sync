...
{% hint style="info" %}
To easily feed Load Network docs to your favourite LLM, access the compressed knowledge (aka LLM.txt) file from Load Network: [llmtxt.xyz/g/loadnetwork/gitbook-sync/16 ](https://llmtxt.xyz/g/loadnetwork/gitbook-sync/16)(last update: 03/11/2025, 16:55:07 UTC)
{% endhint %}
